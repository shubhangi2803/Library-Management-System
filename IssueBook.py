...
def issue():
    ...
    backBtn = Button(root,text="Back",bg='#f2f2f4', fg='black', font='helvetica 12 bold', command=issueBook)
...
def issueBook():
    ...
    headingLabel = Label(headingFrame2, text="ISSUE BOOK", fg='black', font='helvetica 12 bold')
    ...
    #Issue Button
    issueBtn = Button(root,text="Issue",bg='#f2f2f4', fg='black', font='helvetica 12 bold',command=issue)
